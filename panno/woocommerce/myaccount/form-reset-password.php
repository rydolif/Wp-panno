...
<div class="form__container container">
	<form method="post" class="page-form woocommerce-ResetPassword lost_reset_password">

		<p class="form__wrap_line"><?php echo apply_filters( 'woocommerce_reset_password_message', esc_html__( 'Enter a new password below.', 'woocommerce' ) ); ?></p><?php // @codingStandardsIgnoreLine ?>
		...
		<p class="form__wrap_line woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
