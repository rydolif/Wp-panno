...
?>
<div class="checkout__coupon woocommerce-form-coupon-toggle">
...
<form class="woocommerce__form-coupon checkout_coupon woocommerce-form-coupon" method="post" style="display:none">

	<p><?php esc_html_e( 'If you have a coupon code, please apply it below.', 'woocommerce' ); ?></p>

	<p class="checkout__coupon_line form-row form-row-first">
